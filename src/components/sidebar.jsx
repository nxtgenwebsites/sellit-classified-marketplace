...
import '../universal-css/sidebar.css'
    ...
    return (
        <section className="sidebar">
            ...
            <div className="second-section mt-3 rounded-2">
                ...
                <div className="second-dropdown dropdown mt-3">
                    <button type="button"
                        ...
                        <p className="dropdown-btn mb-0"><img src="assets/icons/chevron.svg" alt="IMG" /></p>
                    </button>
                    <div className="dropdown-menu second-menu">
                        ...
                        <a href="#" className="text-decoration-none text-black location-item">
                            <li className="dropdown-item d-flex w-100 px-3 py-2">
                                ...
                                <div className="location-content">
                                    <p className="d-md-block d-none">Kyber Pakhtunkhwa,<br />Pakistan</p>
                                    <p className="d-md-none d-block">Kyber Pakhtunkhwa, Pakistan</p>
                                </div>
                            </li>
                        </a>
                        <a href="#" className="text-decoration-none text-black location-item">
                ...
                <div className="places-section mt-3">
                    ...
                    <ul className="list-unstyled">
                        <a href="#" className="text-decoration-none first-list-item">
                            <li className="mb-2"><span className="hover-span">Punjab</span> (134935)
                            </li>
                        </a>
                        <a href="#" className="text-decoration-none first-list-item">
                            <li className="mb-2"><span className="hover-span">Sindh</span> (43689)
                            </li>
                        </a>
                        <a href="#" className="text-decoration-none first-list-item">
                            <li className="mb-2"><span className="hover-span">Islamabad</span> (12426)
                            </li>
                        </a>
                        <a href="#" className="text-decoration-none first-list-item">
                            <li className="mb-2"><span className="hover-span">Khyber Pakhtunkhwa</span> (11264)
                            </li>
                        </a>
                        <a href="#" className="text-decoration-none first-list-item">
                            <li className="mb-2"><span className="hover-span">Balochistan</span> (1349)
                            </li>
                        </a>
                        <a href="#" className="text-decoration-none first-list-item">
                            <li className="mb-2"><span className="hover-span">Azad Kashmir</span> (1008)
                            </li>
                        </a>
                    </ul>
                </div>
            ...
            <div className="sixth-section mt-3 rounded-2">
                <img src="assets/img/Post Free Classified Ads to Sell Anything Anywhere in Pakistan.jpg" alt="IMG"
                    className="img-fluid" />
            </div>
            <div className="seventh-section mt-3 rounded-2">
                <img src="assets/img/Promote Your Business with Sellit Pakistan.jpg" alt="IMG" className="w-100" />
            </div>
        </section>
    )
}
