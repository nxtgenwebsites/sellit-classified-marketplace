...
export default function Card({ buisness }) {
  return (
    <div>
      <Col
        lg={12}
      ...
      >
        <div className="featured-icon rounded-4">
          <h2 className="fw-semibold">
            {buisness.featured && <MdOutlineStarPurple500 />}
          </h2>
        </div>
        <div className="page-img">
          <img src={buisness.img} alt="IMG" className="rounded-1" />
        </div>
        <div className="page-1-sect d-lg-flex">
          <div className="page-content p-2 mt-sm-0 mt-3">
            <div className="page-category d-flex justify-content-between w-100">
              <h6 className="fw-bold">{buisness.tag}</h6>
            </div>
            <h5 className="fw-medium heading">{buisness.heading}</h5>
            <div className="rating-and-icons gap-4 text-center d-flex my-3 align-items-center">
              <div className="location d-flex gap-3 align-items-center">
                ...
                <div className="location-content">
                  <h6 className="fw-medium">{buisness.location}</h6>
                </div>
              </div>
              <div className="rating d-flex gap-3 align-items-center">
                ...
                <div className="rating-content">
                  <h6 className="fw-medium">{buisness.time}</h6>
                </div>
              </div>
            </div>
            <h5 className="description">{buisness.description}</h5>
          </div>
        </div>
        ...
        <div className="page-2-sect text-lg-end text-start">
          ...
          <div className="content mt-3">
            <div className="price">
              <h3 className="fw-semibold">{buisness.price}</h3>
            </div>
            <div className="views">
