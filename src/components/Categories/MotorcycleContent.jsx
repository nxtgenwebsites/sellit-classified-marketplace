...
export default function MotorcycleContent() {
  ...
  const businessAds = CategoryContentData.Motorcycle || [];
        ...
        <div className="d-flex justify-content-center align-items-center mt-3">
          ...
          {[...Array(totalPages)].map((_, index) => {
            ...
            return (
              <button
                key={pageNum}
                className={`btn mx-1 ${
                  currentPage === pageNum ? "btn-active" : "btn-unactive"
                }`}
          ...
          <button
            className={`btn ms-2 arrow-btn ${
              currentPage === totalPages ? "arrow-disabled" : "arrow-active"
            }`}
            onClick={() =>
