...
import "../Home/css/buisness-profile.css";
            ...
            <Col lg={6}>
              <div className="buisness-card text-lg-start text-center">
                <div className="buisness-img">
                  <img
                    src="assets/img/Buisness img.png"
                    alt="IMG"
                    className="img-fluid"
                  />
                </div>
            ...
            <Col lg={6}>
              <div className="buisness-card text-lg-start text-center">
                ...
                <div className="buisness-btns d-flex mt-4 gap-3 flex-column flex-sm-row">
                  <button type="button" className="px-4 py-3 rounded-3">
                    Sign Up Free{" "}
                    <span>
                      <BsArrowRight />
                    </span>
                  </button>
                  <button type="button" className="rounded-3 tour-btn">
                    Start Tour{" "}
                    <span>
                      <BsArrowRight />
                    </span>
