  ...
  const fetchAd = async () => {
    try {
      ...
      const response = await axios.get(
        `https://sellit-backend-u8bz.onrender.com/api/manage-ads/get-ad/books_sports_ads/${adId}`
      );
  ...
  return (
    <div className="app-container max-w-7xl mx-auto px-4 py-6">
      <div className="simple-nav text-sm text-gray-500 mb-4">
        <p>Home / Books & Sports / {ad.sub_category}</p>
      </div>
              ...
              <div className="product-section mb-8 p-6 border rounded-lg">
                ...
                <div className="specs-grid grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="spec-item">
                    <span className="spec-label text-gray-500">Item Type:</span>
                  ...
                  <div className="spec-item">
                    <span className="spec-label text-gray-500">Language:</span>
                    <span className="spec-value font-medium ml-2">
                      {ad.language}
                    </span>
                  </div>
                  <div className="spec-item">
                    <span className="spec-label text-gray-500">Format:</span>
                    <span className="spec-value font-medium ml-2">
                      {ad.format}
                    </span>
                  </div>
...
export default BooksSportsAdsView;
