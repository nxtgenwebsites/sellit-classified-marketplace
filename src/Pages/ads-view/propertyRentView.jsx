  ...
  const fetchAd = async () => {
    try {
      ...
      const response = await axios.get(
        `https://sellit-backend-u8bz.onrender.com/api/manage-ads/get-ad/property_rent_ads/${adId}`
      );
  ...
  return (
    <div className="app-container max-w-7xl mx-auto px-4 py-6">
      <div className="simple-nav text-sm text-gray-500 mb-4">
        <p>Home / Property Rent / {ad.sub_category}</p>
      </div>
          ...
          <div className="product-header flex flex-col md:flex-row justify-between items-start mb-6 gap-4">
            ...
            <div className="product-price text-right">
              <h2 className="text-2xl md:text-3xl font-bold text-green-600">
                Rs. {Number(ad.rent_price).toLocaleString()}
              </h2>
            ...
            <div className="product-main lg:w-2/3">
              ...
              <div className="product-section mb-8 p-6 border rounded-lg">
                ...
                <div className="specs-grid grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="spec-item">
                    <span className="spec-label text-gray-500">Furnished:</span>
                    <span className="spec-value font-medium ml-2">
                      {ad.furnished ? "Yes" : "No"}
                    </span>
                  </div>
                  <div className="spec-item">
                    <span className="spec-label text-gray-500">Bedrooms:</span>
                    <span className="spec-value font-medium ml-2">
                      {ad.bedrooms}
                    </span>
                  </div>
                  <div className="spec-item">
                    <span className="spec-label text-gray-500">Bathrooms:</span>
                    <span className="spec-value font-medium ml-2">
                      {ad.bathrooms}
                    </span>
                  </div>
                  <div className="spec-item">
                    <span className="spec-label text-gray-500">Storeys:</span>
                    <span className="spec-value font-medium ml-2">
                      {ad.storeys}
                    </span>
                  </div>
...
export default PropertyRentAdsView;
